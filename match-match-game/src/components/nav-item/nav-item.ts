...
export default class NavItem extends BaseComponent {
  ...
  constructor(item: NavItemModel) {
    ...
    this.link = BaseComponent.createElement('a', ['nav-item__link']) as HTMLLinkElement;
    ...
    const image = BaseComponent.createElement('img', ['nav-item__img']) as HTMLImageElement;
